...
(function () {
    ...
    const models = [
        ...
        { id: "claude", name: "Claude", maker: "Anthropic", mark: "A", color: "#1c1e19", text: "#cc785c", svg: `<svg viewBox="0 0 24 24" fill="currentColor" style="width:16px;height:16px;"><path d="M13.2 4.2L20.8 19H17.2L15.4 15.2H8.6L6.8 19H3.2L10.8 4.2H13.2ZM12 7.4L9.8 12.2H14.2L12 7.4Z"/></svg>` },
        ...
        { id: "deepseek", name: "DeepSeek", maker: "DeepSeek", mark: "D", color: "#1c1e19", text: "#0050fe", svg: `<svg viewBox="0 0 24 24" fill="currentColor" style="width:16px;height:16px;"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1-14.5v3h3v2h-3v3h-2v-3H8v-2h3v-3h2z"/></svg>` },
        { id: "ollama", name: "Ollama Local", maker: "Local Llama/DeepSeek", mark: "🦙", color: "#1c1e19", text: "#ffffff", svg: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:16px;height:16px;"><path d="M9 18a3 3 0 0 0 6 0v-4H9v4zM10 9a2 2 0 1 1 4 0v3h-4V9zM7 6v3M17 6v3"/></svg>` }
    ];
